...
/**
 * Builds a gt predicate
 * 
 * @author Humberto Guerrero Jaime
 */
@SuppressWarnings({"rawtypes","unchecked"})
public class GtPredicateBuilder implements PredicateBuilder {
    ...
    public <T extends EntityObject<K>, K extends Serializable> Predicate build(ConditionFilter conditionFilter,
        ...
        if (PredicateBuilderUtils.allArgsAreExpressionBuilders(args)) {
            ...
            return criteriaBuilder.greaterThan(eb1.build(criteriaBuilder, eoPath), eb2.build(criteriaBuilder, eoPath));
            ...
            return criteriaBuilder.greaterThan(eb1.build(criteriaBuilder,eoPath),value);
