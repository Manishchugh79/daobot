...
public class GePredicateBuilder implements PredicateBuilder {
    ...
    public <T extends EntityObject<K>, K extends Serializable> Predicate build(ConditionFilter conditionFilter,
        ...
        if (PredicateBuilderUtils.allArgsAreExpressionBuilders(args)) {
            ...
            return criteriaBuilder.greaterThanOrEqualTo(eb1.build(criteriaBuilder,eoPath),eb2.build(criteriaBuilder,eoPath));
            ...
            return criteriaBuilder.greaterThanOrEqualTo(eb1.build(criteriaBuilder,eoPath),value);
