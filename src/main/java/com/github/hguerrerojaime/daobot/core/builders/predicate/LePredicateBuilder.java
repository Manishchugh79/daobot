...
/**
 * Builds a le predicate
 * 
 * @author Humberto Guerrero Jaime
 */
@SuppressWarnings({"rawtypes","unchecked"})
public class LePredicateBuilder implements PredicateBuilder {
    ...
    public <T extends EntityObject<K>, K extends Serializable> Predicate build(
        ...
        if (PredicateBuilderUtils.allArgsAreExpressionBuilders(args)) {
            ...
            return criteriaBuilder.lessThanOrEqualTo(eb1.build(criteriaBuilder,eoPath),eb2.build(criteriaBuilder,eoPath));
            ...
            return criteriaBuilder.lessThanOrEqualTo(eb1.build(criteriaBuilder,eoPath),value);
